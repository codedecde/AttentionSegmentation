...
BASE_DIR = os.path.join("Configs/CoNLL-Configs/BERT-Base-GS-Model")
...
for METHOD in METHODS:
    ...
    raw = f"""
    {{
      "base_output_dir": "{SCRATCH}/Experiments/CoNLL/BERT-Base-GS-Model/{METHOD}",
      "dataset_reader": {{
    ...
    config_file = os.path.join(CONF_DIR, f"config_{METHOD}.json")
