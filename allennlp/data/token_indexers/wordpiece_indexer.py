...
class PretrainedBertIndexer(WordpieceIndexer):
    ...
    def __init__(self,
        ...
        super().__init__(vocab=bert_tokenizer.vocab,
                         ...
                         separator_token="[SEP]")
    @classmethod
    def from_params(cls, params: Params) -> 'PretrainedBertIndexer':
        pretrained_model = params.pop("pretrained_model")
        use_starting_offsets = params.pop("use_starting_offsets", False)
        do_lowercase = params.pop("do_lowercase", True)
        never_lowercase = params.pop("never_lowercase", None)
        max_pieces = params.pop("max_pieces", 512)
